...
router.put('/', (req, res) => {
  ...
  const allowed = ['approvedPositions', 'approvedSecretaryPositions', 'freeHoursTargets', 'hideFrameworksPage', 'pubHideSupTypes', 'pubHideEducationalTeams', 'pubHideClinicalTeams', 'pubHideInterestGroups'];
  const update = {};
