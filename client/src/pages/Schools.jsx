            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {items.map(fw => {
                  ...
                  return (
                    <tr key={fw.id} className="hover:bg-gray-50 align-top">
                      ...
                      {/* כתות ח"מ */}
                      <td className="table-cell">
                        {fwSpec.length === 0 && addingSpecFor !== fw.id ? (
                        ...
                        <button className="text-xs text-gray-300 hover:text-green-500 mt-0.5 block"
                          onClick={() => addSpec(fw.id)}>+ כיתה</button>
                      </td>
